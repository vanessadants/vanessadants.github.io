...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TodoList__ = __webpack_require__(9);



Object(__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"])(__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__TodoList__["a" /* default */], null), document.getElementById('app'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TodoStore__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TodoItem__ = __webpack_require__(11);
...
var TodoList = /** @class */ (function (_super) {
    ...
    function TodoList(props) {
        ...
        _this.store = new __WEBPACK_IMPORTED_MODULE_1__TodoStore__["a" /* default */]();
    ...
    TodoList.prototype.render = function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("section", { className: "todoapp" },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("header", { className: "header" },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "new-todo", value: newTodo, placeholder: "What needs to be done?", onKeyPress: this.addTodo, onInput: this.updateNewTodo })),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("section", { className: "main" },
                todos.length > 0 && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "toggle-all", type: "checkbox", checked: remainingCount === 0, onChange: this.toggle }),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { htmlFor: "toggle-all" }, "Mark all as complete"),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("ul", { className: "todo-list" }, todosFiltered.map(function (todo) {
                    return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__TodoItem__["a" /* default */], { todo: todo, key: todo.id, onToggle: _this.toggleTodo, onDestroy: _this.destroyTodo, onUpdate: _this.updateTitle });
                }))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("footer", { className: "footer" },
                remainingCount > 0 && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "todo-count" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("strong", null, remainingCount),
                    " item",
                    remainingCount > 1 && 's',
                    " left "),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("ul", { className: "filters" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: "#/", className: __WEBPACK_IMPORTED_MODULE_3_classnames__({ selected: filter === 'all' }), onClick: this.setFilter('all') }, "All")),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: "#/active", className: __WEBPACK_IMPORTED_MODULE_3_classnames__({ selected: filter === 'active' }), onClick: this.setFilter('active') }, "Active")),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: "#/completed", className: __WEBPACK_IMPORTED_MODULE_3_classnames__({ selected: filter === 'completed' }), onClick: this.setFilter('completed') }, "Completed"))),
                completedCount > 0 && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "clear-completed", onClick: this.clearCompleted }, "Clear completed")));
    };
    return TodoList;
...
/* harmony default export */ __webpack_exports__["a"] = (TodoStore);
...
var TodoItem = /** @class */ (function (_super) {
    ...
    TodoItem.prototype.render = function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", { className: __WEBPACK_IMPORTED_MODULE_1_classnames__({ completed: todo.completed, editing: editing }) },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "view" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "toggle", type: "checkbox", onChange: this.toggle, checked: todo.completed }),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { onDoubleClick: this.startEditing }, todo.title),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "destroy", onClick: this.destroy })),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "edit", value: title, onBlur: this.handleSubmit, onKeyDown: this.handleKeyDown, onInput: this.handleInput, type: "text" }));
    };
    return TodoItem;
}(__WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"]));
